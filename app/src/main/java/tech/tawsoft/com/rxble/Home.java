...
public class Home extends Activity {
    ...
    public String ROOT_URL = Constants.ROOT_URL;
    ...
    public void onClick(View v) {
        ...
        String user="2";
        String nfcid = lblNFCID.getText().toString();
        String weight = lblValue.getText().toString();
        ...
        switch (v.getId()) {
            ...
            case R.id.btnSave:
                ...
                ScaleData data = new ScaleData(nfcid,weight,user);
                data.save();
